...
smallest honest substitute. The cookie is HttpOnly, but the catalog also returns the same bearer ID and the client stores it in localStorage. Treat it as a credential, not a public identifier. In a real title this would be the studio's player id and
